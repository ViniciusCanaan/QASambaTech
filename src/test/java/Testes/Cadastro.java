...
public class Cadastro {
    ...
    public void testFazerCadastro(){ //criando um método para fazer login na página
        ...
        navegador.findElement(By.name("name")).sendKeys("Vinícius Canaan");
        navegador.findElement(By.id("registerEmail")).sendKeys("vcfreitas1997@gmail.com");
        navegador.findElement(By.id("registerConfEmail")).sendKeys("vcfreitas1997@gmail.com");
        navegador.findElement(By.id("registerPassword")).sendKeys("12345678");
        navegador.findElement(By.id("registerConfPassword")).sendKeys("12345678");
